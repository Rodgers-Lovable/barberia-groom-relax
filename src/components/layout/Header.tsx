  ...
  return (
    <>
      ...
      <header
        ...
        } left-0 right-0 z-50 transition-all duration-500 ease-out transform h-[150px] ${
          isScrolled
            ? "bg-background shadow-lg translate-y-0 opacity-100"
            : "bg-transparent -translate-y-2 opacity-95"
        }`}
      >
        <div className="mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-3 place-items-center h-[150px]">
            {/* Left Navigation */}
            ...
            <Link
              to="/"
              className={`flex flex-col items-center space-x-3 font-playfair text-sm md:text-2xl font-bold transition-colors ${
                isScrolled
